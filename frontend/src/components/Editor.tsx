...
const Editor = React.memo(({ content, setContent }:{ content: string; setContent: (newContent: any) => void; }) => {
    ...
    <RichTextEditor
      toolbar={{
        ...
        items: [
          ...
          'heading', 'bulletList', 'orderedList', 'textAlign', 'indent',
          'blockquote', 'codeBlock', 'horizontalRule',
          'link', 'image', 'imageGif', 'attachment', 'iframe', 'twitter',
          'slashCommand', 'searchAndReplace', 'emoji', 'table',
          'exportPdf', 'exportWord', 'code', 'subAndSuperScript'
        ],
      }}
      output="html"
      content={content}
